...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=87645515ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="257">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studentmanagement&table=java_notes">`studentmanagement`.`java_notes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studentmanagement&table=os_notes">`studentmanagement`.`os_notes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studentmanagement&table=subjectmaterials">`studentmanagement`.`subjectmaterials`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studentmanagement&table=studentslobby">`studentmanagement`.`studentslobby`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studentmanagement&table=cc_notes">`studentmanagement`.`cc_notes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studentmanagement&table=da_notes">`studentmanagement`.`da_notes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studentmanagement&table=wt_notes">`studentmanagement`.`wt_notes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studentmanagement&table=st_notes">`studentmanagement`.`st_notes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studentmanagement&table=OS_notes">`studentmanagement`.`OS_notes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studentmanagement&table=teacherslobby">`studentmanagement`.`teacherslobby`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2b55252c3a35515277646d2e26406169">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="257"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="studentmanagement" targettable="da_notes">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `studentmanagement`.`da_notes` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `byStudent` VARCHAR(20) NOT NULL ,  `chapter1` LONGTEXT NOT NULL ,  `chapter2` LONGTEXT NOT NULL ,  `chapter3` LONGTEXT NOT NULL ,  `chapter4` LONGTEXT NOT NULL ,  `chapter5` LONGTEXT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="studentmanagement" targettable="da_notes">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `da_notes` DROP `chapter5`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="studentmanagement" targettable="os_notes">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `os_notes`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="studentmanagement" targettable="subjectmaterials">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `subjectmaterials`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="studentmanagement" targettable="subjectmaterials">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `subjectmaterials`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="studentmanagement" targettable="java_notes">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `studentmanagement`.`java_notes` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `byStudent` VARCHAR(20) NOT NULL ,  `chapter1` LONGTEXT NOT NULL ,  `chapter2` LONGTEXT NOT NULL ,  `chapter3` LONGTEXT NOT NULL ,  `chapter4` LONGTEXT NOT NULL ,  `chapter5` LONGTEXT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="studentmanagement" targettable="cc_notes">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `studentmanagement`.`cc_notes` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `byStudent` VARCHAR(20) NOT NULL ,  `chapter1` LONGTEXT NOT NULL ,  `chapter2` LONGTEXT NOT NULL ,  `chapter3` LONGTEXT NOT NULL ,  `chapter4` LONGTEXT NOT NULL ,  `chapter5` LONGTEXT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="studentmanagement" targettable="subjectmaterials">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `subjectmaterials`  
ORDER BY `subjectmaterials`.`subject_code` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="studentmanagement" targettable="os_notes">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `os_notes`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="studentmanagement" targettable="studentslobby">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `studentslobby`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="studentmanagement" targettable="subjectmaterials">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `java_notes`</span>
                        </div>
